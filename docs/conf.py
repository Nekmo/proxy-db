...
# -*- coding: utf-8 -*-
#
# proxy-db documentation build configuration file, created by
...
# os.environ['DJANGO_SETTINGS_MODULE'] = 'proxy-db.settings.develop'
# django.setup()
...
pdf_documents = [('index', u'rst2pdf', u'proxy-db', u'Nekmo'), ]

rinoh_documents = [('index',            # top-level file (index.rst)
                    'target',           # output (target.pdf)
                    'proxy-db',   # document title
