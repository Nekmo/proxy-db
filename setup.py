...
PACKAGE_NAME = 'proxy-db'
PACKAGE_DOWNLOAD_URL = 'https://github.com/Nekmo/proxy-db/archive/master.zip'
MODULE = 'proxy_db'
...
scripts = [os.path.join('scripts', os.path.basename(script))
           for script in glob.glob('{}/scripts/*'.format(here))]
